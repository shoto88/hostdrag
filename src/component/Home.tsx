    ...
    <div className="container mx-auto p-4">
      ...
      <div className="mt-8 flex">
        ...
        <Link to="/add-medication">
          <Button className='ml-5 mr-5 bg-blue-300 p-2'>薬剤ジャンル追加</Button>
        </Link>
        <Link to="/add-drag">
          <Button className='ml-5 mr-5 bg-blue-300 p-2'>薬剤追加</Button>
        </Link>
        <Link to="/edit-medication">
          <Button className='ml-5 mr-5 bg-blue-300 p-2'>薬剤編集</Button>
        </Link>
        <Link to="/medicationslist">
          <Button className='ml-5 mr-5 bg-blue-300 p-2'>薬剤詳細一覧</Button>
        </Link>
        <Link
          to="/prescription-preview"
          state={{ selectedMedications: getSelectedMedications() }}
        >
          <Button className='ml-5 mr-5 bg-blue-300 p-2'>プレビュー</Button>
        </Link>
      </div>
      <div className="mt-8">
